      ...
      extends ListUI
{
   ...
   /**
    * Layout logic for GridList (delegated to BasicGridListUI) 
    * with behaviour similar to a File Manager's folder's iconView.
    * 
    * @author Eitan Suez
    */
   class GridListLayout implements LayoutManager
   {
      int _hgap, _vgap;
