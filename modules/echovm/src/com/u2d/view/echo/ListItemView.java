...
import com.u2d.view.echo.list.CommandsContextMenuView;
 ...
 * Time: 5:17:52 PM
 *
 * TODO: refactor;  almost identical to other iconized views
 */
public class ListItemView extends Label implements ComplexEView
{
...
//      setVerticalTextPosition(SwingConstants.BOTTOM);
      setTextPosition(new Alignment(Alignment.TRAILING, Alignment.DEFAULT));
//      setAlignmentX(0.5f);
//      setAlignmentY(0.5f);
...
//      setBreakPosition(15);
   ...
   public ListItemView(ComplexEObject eo)
   {
      this();
      bind(eo);
   }
   ...
   {
      return _cmdsView.getContextMenu();
   }
   ...
   public void bind(ComplexEObject ceo)
   {
      ...
      setIcon(new ResourceImageReference(_ceo.iconSmResourceRef()));
//         setIcon(_ceo.iconSm());
