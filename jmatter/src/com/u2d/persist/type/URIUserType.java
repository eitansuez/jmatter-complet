 ...
 * @author Eitan Suez
 */
public class URIUserType extends BaseUserType
{
   public boolean equals(Object x, Object y)
   {
      if (x == null || (!(x instanceof URI))) return false;
      return ((URI) x).equals(y);
   }
      ...
      throws HibernateException, java.sql.SQLException
   {
      String text = "";
      if (value != null)
         text = (value instanceof String) ? (String) value : ((URI) value).stringValue();
      // was:
//      String text = (value==null) ? "" : ((URI) value).stringValue();
