 ...
 * @author Eitan Suez
 */
public class SSNUserType extends BaseUserType
{
   public boolean equals(Object x, Object y)
   {
      if (x == null || (!(x instanceof SSN))) return false;
      return ((SSN) x).equals(y);
   }
      ...
      throws HibernateException, java.sql.SQLException
   {
      ...
      return (value==null) ? new SSN() : new SSN(value);
   }
      ...
      throws HibernateException, java.sql.SQLException
   {
      String text = "";
      if (value != null)
         text = (value instanceof String) ? (String) value : ((SSN) value).stringValue();
      // was:
//      String text = (value==null) ? "" : ((SSN) value).stringValue();
      Hibernate.STRING.nullSafeSet(pstmt, text, index);
   }

   public Class returnedClass() { return SSN.class; }
